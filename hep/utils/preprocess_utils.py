...
def regularize_fatjet(
    ...
    **kwargs
    ...
    recl_algo = kwargs.get(
        "recluster_algorithm", "CA"
    )
    n_subjets = kwargs.get(
        "subjets", 3
    )
    if inclusive:
        recl_r = kwargs.get(
        ...
        subjets = np.swapaxes(
            np.array(
                [
                    ...
                    for item in sequence.exclusive_jets(
                        n_subjets
                    )
                ]
            ),
